 ...
 * lib/auth.ts's verifyAdminAuth — no non-admin route in this app ever
 * returns 401), so it's always safe to treat one as "please log in again."
 * The one exception is the login endpoint itself, whose 401 means "wrong
