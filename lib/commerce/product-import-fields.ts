...
export const IMPORT_FIELDS: ImportField[] = [
  ...
  { key: 'sub_sub_category', label: 'Sub-subcategory', hint: 'A third level under sub-category, if you use one' },
...
const HEADER_ALIASES: Record<string, string[]> = {
  ...
  sub_sub_category: ['subsubcategory', 'sub subcategory', 'sub-subcategory'],
